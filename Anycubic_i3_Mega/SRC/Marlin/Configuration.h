...
#define STRING_CONFIG_H_AUTHOR "Dark_Sarmat marlin Anycubic i3 Mega MOD" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 6, 100 }
